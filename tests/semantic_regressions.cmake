...
expect_success("dynamic multi-shot context default selection" "tests/fixtures/dynamic_fragments_many.luna" "40\n42\n42")
expect_success_with_env("dynamic multi-shot context runtime selection" "tests/fixtures/dynamic_fragments_many.luna" "LUNA_FRAGMENT_REPLAY=bracket" "41\n42\n42")
expect_error("dynamic multi-shot continuation rejects consuming captures" "tests/fixtures/dynamic_fragments_many_capture_invalid.luna" "continuation consumes or frees captured state")
...
expect_error("public symbol query all remains blocked" "tests/fixtures/symbol_query_all_blocked_invalid.luna" "symbol_set.all is blocked by TBD-Q004 ordering semantics")
expect_error("public symbol query optional remains blocked" "tests/fixtures/symbol_query_optional_blocked_invalid.luna" "symbol_set.optional public result type is not yet frozen")
