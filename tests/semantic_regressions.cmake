...
expect_error("legacy dynamic multi-shot selection is removed" "tests/fixtures/dynamic_fragments_many.luna" "`context many` is not part of Luna 0.3")
expect_error("legacy dynamic multi-shot capture is removed" "tests/fixtures/dynamic_fragments_many_capture_invalid.luna" "`context many` is not part of Luna 0.3")
...
expect_error("dynamic metadata selector is removed" "tests/fixtures/dynamic_select_removed_invalid.luna" "`dynamic select` was removed in Luna 0.3")
...
expect_error("invalid package kind" "tests/fixtures/packages/package_kind_invalid" "unknown package kind 'plugin'")
...
expect_error("metadata selector has no solution" "examples/versioning_invalid.luna" "symbol query .one() matched no declarations")
expect_error("metadata selector rejects ambiguity" "tests/fixtures/selector_metadata_ambiguous_invalid.luna" "symbol query .one() matched multiple declarations")
...
expect_error("static selector requires a stable target signature" "tests/fixtures/selector_inferred_signature_invalid.luna" "does not have a complete stable signature projection")
expect_success("public typed symbol query" "tests/fixtures/symbol_query_public.luna" "Program exited with code: 42")
expect_success("same-metadata overloads use callable identity" "tests/fixtures/symbol_query_same_metadata_overload.luna" "Program exited with code: 68")
expect_success("public non-function symbol queries include nominal slots" "tests/fixtures/symbol_query_non_function.luna" "Program exited with code: 4")
expect_error("public non-function symbol query rejects unspecialized generic" "tests/fixtures/symbol_query_non_function_generic_invalid.luna" "symbols cannot query unspecialized generic declaration 'Box'")
expect_error("public non-function declaration reference is not callable" "tests/fixtures/symbol_query_non_function_call_invalid.luna" "declaration_ref target of type 'Snapshot' is not callable")
expect_error("public symbol query rejects no match" "tests/fixtures/symbol_query_no_match_invalid.luna" "symbol query .one() matched no declarations")
expect_error("public symbol query rejects ambiguity" "tests/fixtures/symbol_query_ambiguous_invalid.luna" "symbol query .one() matched multiple declarations")
expect_error("public symbol query requires type for heterogeneous family" "tests/fixtures/symbol_query_signature_invalid.luna" "has multiple callable types; provide symbols::<Signature>(family)")
expect_error("public symbol query rejects unspecialized generic" "tests/fixtures/symbol_query_generic_invalid.luna" "contains an unspecialized generic declaration")
expect_success("public symbol query all metadata order and static expansion" "tests/fixtures/symbol_query_all_ordered.luna" "Program exited with code: 2121")
expect_success("public symbol query all accepts an empty set" "tests/fixtures/symbol_query_all_empty.luna" "Program exited with code: 0")
expect_error("public symbol query all rejects duplicate metadata keys" "tests/fixtures/symbol_query_all_duplicate_key_invalid.luna" "symbol query .all metadata order has a duplicate key")
expect_error("public symbol query all requires one metadata key per declaration" "tests/fixtures/symbol_query_all_missing_key_invalid.luna" "metadata order requires exactly one")
expect_error("public symbol query all rejects floating-point keys" "tests/fixtures/symbol_query_all_float_key_invalid.luna" "metadata order does not support floating-point keys")
expect_error("public symbol query all view cannot cross calls" "tests/fixtures/symbol_query_all_view_escape_invalid.luna" "compiler-only value cannot cross a function call boundary")
expect_error("public symbol query all element cannot cross calls" "tests/fixtures/symbol_query_all_ref_escape_invalid.luna" "compiler-only value cannot cross a function call boundary")
expect_error("public symbol query all view cannot be returned" "tests/fixtures/symbol_query_all_view_return_escape_invalid.luna" "compiler-only value cannot cross a function return boundary")
expect_error("public symbol query all element cannot be returned" "tests/fixtures/symbol_query_all_ref_return_escape_invalid.luna" "compiler-only value cannot cross a function return boundary")
expect_error("public symbol query all index is bounds checked" "tests/fixtures/symbol_query_all_index_invalid.luna" "declaration_at index 1 is out of range")
expect_success("public symbol query optional Some" "tests/fixtures/symbol_query_optional_some.luna" "Program exited with code: 42")
expect_success("public symbol query optional None" "tests/fixtures/symbol_query_optional_none.luna" "Program exited with code: 7")
expect_success("public symbol query optional rebind and nested match" "tests/fixtures/symbol_query_optional_rebind_nested.luna" "Program exited with code: 49")
expect_error("public symbol query optional ambiguity" "tests/fixtures/symbol_query_optional_ambiguous_invalid.luna" "symbol query .optional() matched multiple declarations")
expect_error("public symbol query optional cannot escape" "tests/fixtures/symbol_query_optional_escape_invalid.luna" "compiler-only value cannot cross a function return boundary")
expect_error("public symbol query optional cannot cross calls" "tests/fixtures/symbol_query_optional_argument_escape_invalid.luna" "compiler-only value cannot cross a function call boundary")
expect_error("public symbol query optional payload cannot escape" "tests/fixtures/symbol_query_optional_payload_return_escape_invalid.luna" "compiler-only value cannot cross a function return boundary")
expect_error("public symbol query optional payload cannot cross calls" "tests/fixtures/symbol_query_optional_payload_argument_escape_invalid.luna" "compiler-only value cannot cross a function call boundary")
expect_error("public symbol query optional payload cannot cross trait calls" "tests/fixtures/symbol_query_optional_payload_trait_argument_escape_invalid.luna" "compiler-only value cannot cross a trait method call boundary")
...
expect_error("multi-shot context is deferred" "examples/fragment_multishot_invalid.luna" "`context many` is not part of Luna 0.3")
expect_error("multi-shot replay is deferred" "examples/fragment_multishot_free_invalid.luna" "`context many` is not part of Luna 0.3")
expect_error("dynamic apply syntax is removed" "tests/fixtures/dynamic_apply_static_slot_invalid.luna" "`dynamic slot` and `dynamic apply` were removed in Luna 0.3")
...
expect_success_without("interceptor return skips continuation after cleanup" "tests/fixtures/interceptor_return_cleanup_valid.luna" "11\n33" "22")
expect_error("fragment return is unit-only" "tests/fixtures/fragment_return_value_invalid.luna" "return statement: i32 and unit are different types")
...
expect_success("structured CPS continuation return cleans shadowed locals by identity" "tests/fixtures/context_continuation_return_valid.luna" "64\n63")
...
expect_error("fragment nominal target fixes its control contract" "tests/fixtures/slot_fragment_contract_mismatch_invalid.luna" "control form does not match nominal slot 'hook'")
expect_error("local slot declarations are removed" "tests/fixtures/slot_missing_contract_invalid.luna" "slot declarations are module-level in Luna 0.3")
expect_error("multi-shot slot contracts are deferred" "tests/fixtures/slot_cardinality_contract_mismatch_invalid.luna" "`context many` is not part of Luna 0.3")
expect_error("blockless apply is removed" "tests/fixtures/apply_contract_checked_eagerly_invalid.luna" "lexical `apply` requires a body")
expect_error("dynamic candidate syntax is removed" "tests/fixtures/dynamic_candidate_contract_mismatch_invalid.luna" "`dynamic slot` and `dynamic apply` were removed in Luna 0.3")
...
expect_success_without("question mark in a continuation returns through fragment cleanup" "tests/fixtures/context_continuation_try_cleanup_valid.luna" "62\n7" "99")
