...
|---|---|---|---|---|
| `RLS001` | Candidate commit topology | Local candidates exist at Luna `41ce85e`, Toolchains `e48ba16`, and Lunax `d8ba00e`; the three worktrees are clean before this status-only update | Preserve the Luna semantic candidate and follow it later with a separate root lock/status promotion commit | No; locally complete |
