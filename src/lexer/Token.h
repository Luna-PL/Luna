...
enum class TokenKind {
    // Keywords
    Fn, Let, Const, Constexpr, New, Move, Borrow, Linear, Mut, Free, Extern, Auto, Return,
    Fragment, Interceptor, Context, Many, Slot, Resume, Abort, Apply, Default, Dynamic, Kernel, Launch, Await,
    ...
    Identifier, IntLiteral, FloatLiteral, VersionLiteral, StringLiteral,
    // Operators
...
const std::unordered_map<std::string, TokenKind> KEYWORDS = {
    ...
    {"borrow", TokenKind::Borrow}, {"linear", TokenKind::Linear},
...
inline std::string tokenKindName(TokenKind k) {
    switch (k) {
        ...
        case TokenKind::VersionLiteral: return "version literal";
