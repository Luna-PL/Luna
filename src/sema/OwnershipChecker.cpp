...
bool OwnershipChecker::checkExpr(Expr* expr) {
    ...
    if (auto* record = dynamic_cast<RecordLiteralExpr*>(expr))
        return checkRecordLiteral(record);
